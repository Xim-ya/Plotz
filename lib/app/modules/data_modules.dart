...
abstract class DataModules {
  ...
  static Future<void> getDependencies() async {
    ...
    /* Youtube */
    Get.lazyPut<YoutubeApi>(YoutubeApiImpl.new, fenix: true);
    Get.lazyPut<YoutubeDataSource>(() => YoutubeDataSourceImpl(Get.find()),
        fenix: true,);

    /* Auth */
    Get.lazyPut<AuthApi>(AuthApiImpl.new, fenix: true);
    ...
    /* User */
    Get.lazyPut<UserApi>(UserApiImpl.new, fenix: true);
    ...
    Get.lazyPut(Dio.new, fenix: true);

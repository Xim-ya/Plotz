...
//  * */
//
// class LoadCachedCategoryContentCollectionUseCase extends BaseNoParamUseCase <Result<CategoryContentCollection>>{
//
...
//         await LocalStorageService.to.getData(fieldName: 'categoryCollection');
//

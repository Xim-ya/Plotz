import 'package:uppercut_fantube/domain/useCase/search/search_content_use_case.dart';

import 'dart:developer';
import 'package:uppercut_fantube/utilities/index.dart';

class SearchPagingContentUseCase  {
  SearchPagingContentUseCase(this._repository);

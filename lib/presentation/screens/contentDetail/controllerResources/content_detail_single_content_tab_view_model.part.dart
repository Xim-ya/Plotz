...
extension ContentDetailSingleContentTabViewModel on ContentDetailViewModel {
  ...
  List<ContentEpisodeInfoItem>? get contentEpisodeList =>
      _contentEpisodeList.value;

  // 컨텐츠 댓글 리스트
  List<YoutubeContentComment>? get commentList => _contentCommentList.value;

  // 컨텐츠 유튜브 비디오
  List<ContentVideoItem>? get youtubeVideos => contentVideos.value?.videos;
  ...
  String? get contentOverView =>
      passedArgument.description ?? _contentDescriptionInfo.value?.overView;
